...
export class CharacterAgent {
    ...
    private generateSystemPrompt(responseMessage: string) {
        ...
        return `
            You are message converter for a character ${AI_NAME} defined by these core characteristics:
            ${coreCharacteristics}
            
            Please CONVERT the following message under 'Message to Convert:' as if you as the character were ${AI_NAME} saying that message in a text chat.
